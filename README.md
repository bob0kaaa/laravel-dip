...
Проект реализован с помощью Фреймворк Laravel 10.30.0 с использованием PHP 8.2, NodeJS 18.16.0, composer 2.6.4  и бесплатной библеотекой с открытым кодом "PHP Qr Code", БД PostgreSQL.
